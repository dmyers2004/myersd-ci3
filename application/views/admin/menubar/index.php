<div class="header">
	<h3>Menubars<small class="hidden-phone">The Menubar Page allows you to create the navigation menu for use in your layouts.</small></h3>
	<a href="/admin/menubar/new" class="btn btn-small add-btn"><i class="icon-magic"></i> Add Root Menubar</i></a>
</div>
<div class="row-fluid">
  <div class="span6 dd">
		<?=make($tree) ?>
