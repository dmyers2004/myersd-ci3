...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?=site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;">Finish your registration...</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?=site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;"><?=site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?></a></nobr><br />
<br />
...
<br />
<br />
<?php if (strlen($username) > 0) { ?>Your username: <?=$username; ?><br /><?php } ?>
Your email address: <?=$email; ?><br />
<?php if (isset($password)) { /* ?>Your password: <?=$password; ?><br /><?php */ } ?>
<br />
<br />
Have fun!<br />
The <?=$site_name; ?> Team
