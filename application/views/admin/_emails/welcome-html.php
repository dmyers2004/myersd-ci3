...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?=site_url('/auth/login/'); ?>" style="color: #3366cc;">Go to <?=$site_name; ?> now!</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?=site_url('/auth/login/'); ?>" style="color: #3366cc;"><?=site_url('/auth/login/'); ?></a></nobr><br />
<br />
<br />
<?php if (strlen($username) > 0) { ?>Your username: <?=$username; ?><br /><?php } ?>
Your email address: <?=$email; ?><br />
<?php /* Your password: <?=$password; ?><br /> */ ?>
<br />
<br />
Have fun!<br />
The <?=$site_name; ?> Team
